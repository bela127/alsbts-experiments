...
for i in np.arange(0, 5, 1):
    ...
    dc = RunComputer(
        base_path=f"/home/bela/Cloud/code/Git/alsbts-experiments/eval/int_brown_exp_var_int{i}_stdsel",
        sub_exp_folder=f"int_brown_exp_var_int{i}_stdsel",
    )
    eval_res = dc.load_exp()

    plot_rmse_over_mean_meas(eval_res, exp_quant_name=f"stdsel_{i}")
